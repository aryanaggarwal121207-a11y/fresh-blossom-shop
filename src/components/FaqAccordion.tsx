...
export const FAQ_ITEMS = [
  { q: "Are STfresh products natural?", a: "Yes. Every STfresh product is crafted with plant-based, natural ingredients like rose, aloe vera and papaya, free from parabens and harsh chemicals." },
  ...
  { q: "What is your return policy?", a: "You can return unopened products within 7 days of delivery for a full refund. See our Return Policy page for details." },
