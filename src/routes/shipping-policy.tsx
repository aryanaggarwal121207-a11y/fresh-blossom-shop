...
export const Route = createFileRoute("/shipping-policy")({
  component: () => (
    <LegalPage title="Shipping Policy" updated="July 2026" sections={[
      { h: "Delivery time", p: "Standard delivery takes 4–6 business days. Express delivery arrives in 1–2 business days. Orders are processed within 24 hours on business days." },
