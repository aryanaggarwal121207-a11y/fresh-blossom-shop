...
export const Route = createFileRoute("/terms")({
  component: () => (
    <LegalPage title="Terms & Conditions" updated="July 2026" sections={[
      { h: "Acceptance of terms", p: "By accessing and using the STfresh website, you agree to be bound by these terms and conditions and our privacy policy." },
      ...
      { h: "Intellectual property", p: "All content on this site, including images, logos and text, is the property of STfresh and may not be used without permission." },
      { h: "Limitation of liability", p: "STfresh is not liable for any indirect or consequential damages arising from the use of our products or website, to the extent permitted by law." },
    ]} />
  ),
